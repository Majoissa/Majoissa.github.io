$(function () {
  ...
  function randomCategoryShortName() {
    const categoryShortNames = ["L", "D", "S"];
    const randomIndex = Math.floor(Math.random() * categoryShortNames.length);
    return categoryShortNames[randomIndex];
  }

  var specialsLink = document.querySelector("#specials-tile");
  specialsLink.onclick = function () {
    var randomCategory = randomCategoryShortName();
